...
// Select key-value pairs template
const form = document.querySelector('[data-form]')
const queryParametersContainer = document.querySelector('[data-query-params]')
...
.addEventListener("click", () => {
    queryParametersContainer.append(createKeyValuePair())
})
...
form.addEventListener('submit', event => {
    ...
    try {
        ...
        alert('JSON data is unrecognizable...')
        return
    }
    ...
    axios({
        ...
        params: keyValuePairsToObjects(queryParametersContainer),
